...
namespace ProjectTeam
{
    class Sqlcommands
    {
        ...
        public Sqlcommands()
        {
            dataConnection.ConnectionString = @"Data Source=DESKTOP-T73FOFC\SQLEXPRESS;Initial Catalog=BuddyTeam;Integrated Security=True";
        ...
        //đưa câu SQL vô thực thi lệnh này thành công -> 1, ko thanhf công -> false
        /// <summary>
        ...
        // lập trình thủ tục (chạy vòng for...( khai báo biến, đưa vào các tham số)
        //@ loại bỏ các kí tự đặc biệt
        //tổng vòng for đưa tham số vào kiểm tra 
